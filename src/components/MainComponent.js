...
import {postWorker, postComment, postRating, fetchClients, fetchComments, fetchRatings, fetchWorkers} from '../redux/ActionCreators';
...
const mapDispatchToProps = dispatch => ({
  ...
  postWorker: (naam,experience,phno,gender,area) => dispatch(postWorker(naam,experience,phno,gender,area)),
    ...
    return (
      <div>
        ...
        <Switch>
            ...
            <Route path="/signup_worker" component={() => <Signup_worker workers={this.props.workers.workers} 
                                                                        postWorker = {this.props.postWorker}/>}/>
